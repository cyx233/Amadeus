import { Bell, Bot, Database, GitBranch, Info, Key, ListChecks, Mic, MonitorPlay, Palette } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'knowledge', labelKey: 'mainTabs.knowledge', icon: Database },
